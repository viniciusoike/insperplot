...
insperplot uses custom fonts for the best visual appearance: **EB Garamond** (serif, for titles) and **Barlow** (sans-serif, for body text). You have two options:
...
**Note:** If fonts are unavailable, plots automatically fall back to system defaults.
