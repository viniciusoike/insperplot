...
#' **Colors:**
#' \itemize{
#'   \item \code{\link{show_insper_colors}} - Extract Insper brand colors
...
#'   \item **categorical, accent** - Additional color options
#' }
#'
...
#' library(ggplot2)
#' ggplot(mtcars, aes(x = wt, y = mpg)) +
#'   geom_point(color = show_insper_colors("reds1")) +
#'   theme_insper()
#' }
